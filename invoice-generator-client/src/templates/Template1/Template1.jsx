        ...
        <div className="template1-wrapper">
            ...
            <div className="d-flex justify-content-between align-items-start mb-5">
                <div className="d-flex flex-column align-items-start">
                    ...
                    <div className="t1-company-name t1-orange-text">{data.companyName || "Engineer Talks"}</div>
                    <div className="t1-header-info text-muted">
                ...
                <div className="t1-invoice-details">
                    <div className="t1-title t1-orange-text">{data.title || "Invoice"}</div>
            ...
            <div className="row g-4 mb-4">
                <div className="col-6">
                    <div className="t1-billed-box t1-light-bg">
                        <div className="t1-box-title t1-orange-text">Billed by</div>
                ...
                <div className="col-6">
                    <div className="t1-billed-box t1-light-bg">
                        <div className="t1-box-title t1-orange-text">Billed to</div>
            ...
            {/* Totals Section */}
            <div className="t1-totals-container">
                <div className="t1-totals-box t1-light-bg">
                    <div className="t1-totals-row text-dark fw-medium">
                        <span>Sub Total</span>
                    ...
                    <div className="t1-totals-row t1-grand-total t1-orange-text mt-2 pt-2" style={{borderTop: '1px solid #fecba1'}}>
                        <span>Total</span>
            ...
            <div className="t1-remarks-section">
                <div className="t1-remarks-title t1-orange-text">Remarks</div>
