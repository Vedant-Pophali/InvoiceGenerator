        ...
        <div className="template3-wrapper">
            ...
            <div className="d-flex justify-content-between align-items-start mb-5">
                <div className="d-flex flex-column align-items-start">
                    ...
                    <div className="t3-company-name t3-primary-text">{data.companyName || "Engineer Talks"}</div>
                    <div className="t3-header-info text-muted">
                ...
                <div className="t3-invoice-details">
                    <div className="t3-title t3-primary-text">{data.title || "Invoice"}</div>
            ...
            <div className="row g-4 mb-4">
                <div className="col-6">
                    <div className="t3-billed-box t3-light-bg">
                        <div className="t3-box-title t3-primary-text">Billed by</div>
                ...
                <div className="col-6">
                    <div className="t3-billed-box t3-light-bg">
                        <div className="t3-box-title t3-primary-text">Billed to</div>
            ...
            {/* Totals Section */}
            <div className="t3-totals-container">
                <div className="t3-totals-box t3-light-bg">
                    <div className="t3-totals-row text-dark fw-medium">
                        <span>Sub Total</span>
                    ...
                    <div className="t3-totals-row t3-grand-total t3-primary-text mt-2 pt-2" style={{borderTop: '1px solid #d0dcf5'}}>
                        <span>Total</span>
            ...
            <div className="t3-remarks-section">
                <div className="t3-remarks-title t3-primary-text">Remarks</div>
